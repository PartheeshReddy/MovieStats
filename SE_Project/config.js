// Configuration file for the Movie Stats application

const CONFIG = {
    // TMDb API Configuration
    TMDB: {
        API_KEY: '0fadad06718dee7d858826aba3b384a4', // Replace with your actual API key
    ...
    OMDB: {
        API_KEY: '20cf33eb', // Replace with your actual API key
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (CONFIG.TMDB.API_KEY === '0fadad06718dee7d858826aba3b384a4') {
        console.warn('TMDb API key not configured. Please add your API key to config.js');
    }
    
    if (CONFIG.OMDB.API_KEY === '20cf33eb') {
        console.warn('OMDb API key not configured. Please add your API key to config.js');
    }
});
